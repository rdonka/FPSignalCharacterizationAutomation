...
::: {layout-ncol=2}
![No Signal - Quality = 0](Example Traces\SignalN_Quality0_dLight.png){width=40% fig-align="center"}

![No Signal - Quality = 1](Example Traces\SignalN_Quality1_dLight.png){width=40% fig-align="center"}

![Signal - Quality = 2](Example Traces\SignalY_Quality2_dLight.png){width=40% fig-align="center"}

![Signal - Quality = 3](Example Traces\SignalY_Quality3_dLight.png){width=40% fig-align="center"}
:::
